...
import (
	...
	"github.com/ripta/linkerd-dynauth/internal/controller"
...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "8d837c94.k.r8y.net",
	...
	if err = (&controller.DynamicServerAuthorizationReconciler{
		Client: mgr.GetClient(),
		Scheme: mgr.GetScheme(),
	}).SetupWithManager(mgr); err != nil {
		setupLog.Error(err, "unable to create controller", "controller", "DynamicServerAuthorization")
		os.Exit(1)
	}
